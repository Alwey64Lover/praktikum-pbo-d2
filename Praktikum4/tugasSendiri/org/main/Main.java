/*
  ...
  Penulis : Alwey Hakim
  Deskripsi : Kelas Main untuk mengimplementasikan kelas-kelas Student, Lecture, Course, Advisor, dan LabAssistant.
 */
...
public class Main {
  public static void main(String[] args) {
    System.out.println("TESTCASE PERTEMUAN 2 (ASOSIASI) =======================");
    ...
    System.out.println("TESTCASE PERTEMUAN 3 (INHERITANCE) =======================");
    Advisor sandy = new Advisor("Sandy", 28, "Jl Banjarsari no 12", 10001);
    LabAssistant igun = new LabAssistant("igun", 18, "PK biru", 20001);

    sandy.adviseStudent(igun); sandy.adviseStudent(cahyo);
    igun.assistCourse(cs101); igun.assistCourse(cs102); 
